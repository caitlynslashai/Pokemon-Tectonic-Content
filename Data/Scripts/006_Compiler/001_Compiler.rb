...
module Compiler
    ...
    def compile_all(mustCompile)
      ...
      if mustCompile
        ...
        unless $LegalityErrors.empty?
          yield(_INTL("BATTLE LEGALITY ERRORS FOUND"))
          echoln("\r\n")
          $LegalityErrors.each do |legalityError|
            echoln(legalityError)
          end
          print("One or more legality errors was encountered. Compilation will be aborted.\r\nCheck the console for information about the errors.\r\n\r\nThe game will close on closing this popup.")
          Kernel.exit! true
        end
    ...
    def logLegalityError(errorMessage)
      $LegalityErrors.push(errorMessage)
    end
    ...
    def main
        ...
        Input.update
        mustCompile = true if Input.press?(Input::CTRL) || ARGV.include?("compile") || $FORCECOMPILE
